...
<script src="<?=base_url();?>assets/js/admin/Academic/Academic.js?v=11"></script>
...
<script src="<?=base_url();?>assets/js/admin/Academic/AcadeEnroll.js?v=36.2"></script>
<script src="<?=base_url();?>assets/js/admin/Academic/AcadeRegisRepeat.js?v=17.5"></script>
...
<script src="<?=base_url();?>assets/js/admin/Academic/AcadeRegisterSubject.js?v=16.1"></script>
...
<script src="<?=base_url();?>assets/js/admin/Academic/AcadeReport.js?v=22"></script>
<script src="<?=base_url();?>assets/js/admin/Academic/AcadeStudent.js?v=14.5"></script>
<?php endif; ?>
