                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        <div class="d-flex align-items-center me-3">
                            ...
                            <input type="text" class="form-control thaiDateTimeStart w-auto" name="c_onoff_regisstart" id="c_onoff_regisstart" placeholder="เลือกวันที่" value="">
                            <p id="result"></p>
                        </div>
                      
                        <div class="d-flex align-items-center me-3 mt-3 ">
                            <label for="c_onoff_term" class="me-2">วันที่ปิดลงทะเบียน:</label>
                            <input type="text" class="form-control thaiDateTimeEnd w-auto" name="c_onoff_regisend" id="c_onoff_regisend" placeholder="เลือกวันที่" value="">
                        </div>
