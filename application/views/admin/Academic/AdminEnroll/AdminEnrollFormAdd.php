                ...
                <form id="FormEnroll" method="post" novalidate>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="app-card app-card-settings shadow-sm p-4">
                                <div class="app-card-body">
                                    <select class="" name="subjectregis" id="subjectregis" required autocomplete="off">
                    ...
                    <div class="row g-4 settings-section">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="app-card app-card-settings shadow-sm p-4">
                                <div class="app-card-body">
                                    <select name="teacherregis" id="teacherregis" required>
                    ...
                    <div class="row g-4 settings-section">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="app-card app-card-settings shadow-sm p-4">
                                <div class="app-card-body">
                                    <select name="Room" id="Room" class="mb-3" required>
