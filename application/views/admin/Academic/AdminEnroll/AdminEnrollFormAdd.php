            ...
            <section class="we-offer-area">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <select name="subjectregis" id="subjectregis">
                                    <option value="">เลือกวิชาเรียน</option>
                                    <?php foreach ($subject as $key => $v_subject): ?>
                                    <option value="<?=$v_subject->SubjectCode?>">
                ...
                <div class="row g-4 settings-section">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <select name="teacherregis" id="teacherregis">
                ...
                <div class="row g-4 settings-section">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <select name="Room" id="Room" class="mb-3">
                        ...
                        <!--//app-card-->
                        <div class="mt-3">
                        <button type="button" class="btn btn-success w-100">บันทึก</button>
                        </div>
