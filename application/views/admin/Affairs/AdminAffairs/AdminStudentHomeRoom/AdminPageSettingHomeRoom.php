        ...
        <div class="container-xl">
            ...
            <div class="row g-4 settings-section">
                    <div class="col-12 col-md-3">
                        <h3 class="section-title">เปิดระบบถึง... ของทุกวัน</h3>
                        <div class="section-intro">ตั้งค่าการเปิดบันทึกข้อมูล</div>
                    </div>
                    <div class="col-12 col-md-3">
                        <form class="settings-form">
                            <div class=" mb-3">                              
                                    <input type="time" class="form-control form-control-lg"  id="set_homeroom_time" name="set_homeroom_time" value="<?=$Time[0]->set_homeroom_time?>">
