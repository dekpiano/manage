        ...
        <ul class="list-unstyled">
            <li><a href="#TeacherLarn" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="TeacherLarn" class="collapse list-unstyled <?=$this->uri->segment(2) == 'Teaching' ? 'show' : '' ?>">
                    <li class="<?=$this->uri->segment(3) == 'CheckHomeRoomMain' || $this->uri->segment(3) == 'CheckHomeRoomAdd'|| $this->uri->segment(3) == 'CheckHomeRoomStatistics' ? 'active' : '' ?>"><a href="<?=base_url('Teacher/Teaching/CheckHomeRoomMain');?>">เช็ตชื่อโฮมรูม</a></li>
