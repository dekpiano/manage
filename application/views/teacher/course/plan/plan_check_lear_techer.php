...
<div class="breadcrumb-holder container-fluid">
    <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?=base_url('Teacher/Course/CheckPlan')?>">กลุ่มสาระ</a></li>
        <li class="breadcrumb-item"><a href="<?=base_url('Teacher/Course/CheckPlan/'.$lean[0]->lear_id)?>"><?=$lean[0]->lear_namethai?></a></li>
