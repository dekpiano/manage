            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">แนะนำให้คุณครู รวมไฟล์งานเป็นไฟล์เดียว ตามประเภทที่จะส่ง  อย่างเช่น  แผนการสอนหน้าเดียว ถึงคุณครูจะทำไฟล์งานแยกกันเป็นไฟล์ ก็ให้ก๊อปมาวางเป็นไฟล์เดียวกัน เพื่อให้ผู้ตรวจไฟล์งานจะได้ตรวจง่าย ไม่ต้องเปิดไปเปิดมา</p>
                        <h4 class="card-title">ช่องหมายเหตุ</h4>
                        <p class="card-text">จะเป็นการดีมากถ้าคุณครูบอกรายละเอียดเบื้องต้นเกี่ยวไฟล์ที่ส่ง เช่น ส่งครบตามกำหนดแล้ว หรือ ส่งแผนที่ 5 ถึงที่ 8 แล้ว เป็นต้น</p>
                        <h4 class="card-title">กรณีเปลี่ยนไฟล์ใหม่หรืออัพเดทไฟล์ใหม่</h4>
                        <p class="card-text">ให้คุณครูกลับไปที่หน้าแผนการสอน แล้วคลิกเมนูแก้ไขเพื่อแก้ไขหรือเปลี่ยนไฟล์ที่แก้ใหม่</p>
                    </div>
                </div>
            </div>
        </div>
